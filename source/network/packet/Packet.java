...
public final class Packet {
	...
	public int readLEInt() {
		return (pData[caret++] & 0xff) | ((pData[caret++] & 0xff) << 8) | ((pData[caret++] & 0xff) << 16) | ((pData[caret++] & 0xff) << 24);
	}
	...
	public long readLong() {
		return ((long) (pData[caret++] & 0xff) << 56) | ((long) (pData[caret++] & 0xff) << 48) | ((long) (pData[caret++] & 0xff) << 40) | ((long) (pData[caret++] & 0xff) << 32) | (
				(long) (pData[caret++] & 0xff) << 24) | ((long) (pData[caret++] & 0xff) << 16) | ((long) (pData[caret++] & 0xff) << 8) | ((pData[caret++] & 0xff));
	}
