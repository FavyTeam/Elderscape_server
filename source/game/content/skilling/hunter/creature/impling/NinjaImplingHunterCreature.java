 ...
 */
//@CustomNpcComponent(id = 1653, type = GameType.OSRS)
@CustomNpcComponent(identities = @GameTypeIdentity(type=GameType.OSRS, identity = 1653))
public class NinjaImplingHunterCreature extends HunterCreature {

	public NinjaImplingHunterCreature(int npcId, int npcType) {
		super(npcId, npcType);
	}
	...
	public Npc copy(int index) {
		return new NinjaImplingHunterCreature(index, npcType);
	}
	...
	public GameItem[] captureReward() {
		return new GameItem[] { new GameItem(11254) };
	}
