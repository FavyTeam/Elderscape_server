 ...
 */
//@CustomNpcComponent(id = 1648, type = GameType.OSRS)
@CustomNpcComponent(identities = @GameTypeIdentity(type=GameType.OSRS, identity = 1648))
public class EarthImplingHunterCreature extends HunterCreature {

	public EarthImplingHunterCreature(int npcId, int npcType) {
		super(npcId, npcType);
	}
	...
	public Npc copy(int index) {
		return new EarthImplingHunterCreature(index, npcType);
	}
	...
	public GameItem[] captureReward() {
		return new GameItem[] { new GameItem(11244) };
	}
