 ...
 */
//@CustomNpcComponent(id = 1651, type = GameType.OSRS)
@CustomNpcComponent(identities = @GameTypeIdentity(type=GameType.OSRS, identity = 1651))
public class NatureImplingHunterCreature extends HunterCreature {

	public NatureImplingHunterCreature(int npcId, int npcType) {
		super(npcId, npcType);
	}
	...
	public Npc copy(int index) {
		return new NatureImplingHunterCreature(index, npcType);
	}
	...
	public GameItem[] captureReward() {
		return new GameItem[] { new GameItem(11250) };
	}
