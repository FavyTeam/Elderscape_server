...
public abstract class Task {
	 ...
	 *
	 * @param immediate A flag that indicates if for the first execution there should
	 * be no delay.
	 */
	 ...
	 * @param delay The number of cycles between consecutive executions of this
	 * task.
	 * @param immediate A flag which indicates if for the first execution there should
	 * be no delay.
	 * @throws IllegalArgumentException if the {@code delay} is not positive.
	 */
